...
function createCountryCard(country) {
    clearAll();
    const c = country[0];
    const readyCard = `<div class = "country-card"> <div class = "country-card--header"> 
    <img src="${c.flags.svg}" alt="Country flag" width="55" height="35"> 
    <h2 class="country-card--name"> ${c.name.official} </h2> </div>
...
function createCountryList(country) {
    ...
    <span class="country-list--name">${c.name.official}</span></li>`)
        .join("");
